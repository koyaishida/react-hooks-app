  ...
  return(
    <>
      ...
      <form>
        ...
        <button className="btn btn-danger m-2" onClick={deleteAllOperationLogs} disabled={state.operationLogs.length === 0}>全ての操作ログを削除する</button>
      </form>
    </>
  )
}
